...
execute as @e[tag=ija-a4-block] at @s if block ~ ~ ~ chest{CustomName:'{"color":"blue","text":"Súper cofre"}'} run particle minecraft:sneeze ~ ~ ~ 0.5 0.5 0.5 0.001 3 force
execute as @e[tag=ija-a4-block] at @s if block ~ ~ ~ chest{CustomName:'{"color":"dark_purple","text":"Cofre raro"}'} run particle minecraft:dragon_breath ~ ~ ~ 0 0 0 0.02 10 force
